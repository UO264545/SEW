APIs usadas: JQuery, Drag and drop, File
Funcionamiento de la aplicación web:
La aplicación lee un archivo JSON con diferentes temáticas y permite seleccionar un archivo JSON siempre que siga el esquema utilizado.
